...
def make_args_list(n_trials, dataset_names, algorithms, n_hparams_from, n_hparams, steps,
    data_dir, task, holdout_fraction, single_test_envs, hparams, arg_test_envs=None,
    ablat_TCRI_TCRI=False, ablat_TCRI_TIC=False):
    args_list = []
    for trial_seed in range(n_trials):
        for hparams_seed in range(n_hparams_from, n_hparams):
            for dataset in dataset_names:
                for algorithm in algorithms:
                    if arg_test_envs is not None:
                        all_test_envs = [arg_test_envs]
                    ...
                    for test_envs in all_test_envs:
                        ...
                        train_args['ablat_TCRI_TCRI'] = ablat_TCRI_TCRI
                        train_args['ablat_TCRI_TIC'] = ablat_TCRI_TIC
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_envs', nargs='+', type=int, default=None)
    ...
    parser.add_argument('--ablat_TCRI_TCRI', action='store_true')
    parser.add_argument('--ablat_TCRI_TIC', action='store_true')
    ...
    args_list = make_args_list(
        ...
        arg_test_envs=args.test_envs,
        ablat_TCRI_TCRI=args.ablat_TCRI_TCRI,
        ablat_TCRI_TIC=args.ablat_TCRI_TIC,
    )
    ...
    if args.command == 'launch':
        to_launch = [j for j in jobs if j.state == Job.NOT_LAUNCHED or \
        j.state == Job.INCOMPLETE]
